...
?>
     ...
     function validar()
    {
        ...
        var medida = document.getElementById("txtmedidas").value;

        if (talla.trim().length<1) 
        {
            alert("El campo nombre de talla esta vacio");
            return false;
        }
        if (medida.trim().length<1) 
        {
            alert("El campo medidas esta vacio");
            return false;
        }

}

function verificar_medida(id)
	{
	  $.getJSON("Validaciones/verificar_medida.php?p=" + id).done(function(datos)  
	    {
	      if (datos[0][0]>0) 
	      {
	        alert("Esta talla ya existente");
    ...
    function validarmodal()
    {
        ...
        var medida = document.getElementById("medi").value;
        ...
        function eliminar(id){
         if (confirm("¿Estas seguro de eliminar el registro?")) {
            ...
            window.location = "size.php?id_eliminar=" + id;

         }
      }

      function modificar(id){
         window.location = "size.php?idmodificar=" + id;
      }
...
if (isset($_POST['btninsertar'])){
    ...
    @$result = $obj->Ejecutar_Instruccion("INSERT INTO `tallas`(`nombre`, `medida`) VALUES ('$talla','$medidas')");
    echo '<script>window.location = "size.php"; </script>';
    }
    else if (isset($_GET['id_eliminar']))
        {
            $id = $_GET['id_eliminar'];
             $obj->Ejecutar_Instruccion("delete from tallas where id_talla = '$id'");
        }
        if (isset($_POST['btnbuscar'])){
@$buscar = $_POST['txtbuscar'];
$result = @$obj->Ejecutar_Instruccion("select * from tallas WHERE nombre LIKE '%$buscar%' or medida LIKE '%$buscar%' ");
}
else{
$result = $obj->Ejecutar_Instruccion("select * from tallas");
}
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                         ...
                         <a href="leagues.php" class="nav-item nav-link">Ligas</a>
                            ...
                            <a href="size.php" class="nav-item nav-link active">Tallas</a>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5">    
                        ...
                        <h3 class="mb-30">Formulario</h3>
                            <div class="row">
                            <form action="size.php" id="frminsertar" name="frminsertar" method="POST" autocomplete="off" onsubmit="return validar()">
                                <div class="col-md-10">
                                    <label>Nombre</label>
                                    <input class="form-control" type="text" name="txttalla" id="txttalla" placeholder="Nombre de Talla"  onblur="javascript: verificar_medida(this.value);" maxlength="5" minlength="1" style="width: 392px;">
                                </div>
                                <div class="col-md-10">
                                    <label>Medidas</label>
                                    <input class="form-control" type="text" name="txtmedidas" id="txtmedidas" placeholder="Medidas" maxlength="15" minlength="1"  style="width: 392px;">
                                </div>
        ...
        <!-- Modal Rechazar -->
		  <div class="modal fade" id="editar" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                     ...
                     <!--formulario-->
                     <form action="size-edit.php" method="POST" enctype="multipart/form-data" onsubmit="return validarmodal()">
                                     <div class="form-group">
                                <div class="col-md-10">
                                <input type="hidden" id="ide" name="txtid"  class="form-control" placeholder="ID">
                                    <label>Nombre</label>
                                    <input class="form-control" type="text" name="txttalla" id="talla" placeholder="Nombre de talla"  onblur="javascript: verificar_medida(this.value);" maxlength="5" minlength="1" style="width: 392px;">
                                </div>
                                <div class="col-md-10">
                                    <label>Medidas</label>
                                    <input class="form-control" type="text" name="txtmedidas" id="medi" placeholder="Medidas"  maxlength="15" minlength="1"  style="width: 392px;">
                                </div>
                                     </div>
