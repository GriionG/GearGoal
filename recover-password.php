...
if (isset($_POST['btniniciar'])) {
    ...
    $_SESSION['id_usuario'] = $datos[0][0];
        ...
        $_SESSION['discapasidad']= $datos[0][9];
        $_SESSION['pregunta'] = $datos[0][10];
        $_SESSION['respuesta']= $datos[0][11];
        $_SESSION["loggedin"] = true;

    if($email == $_SESSION['email'] = $datos[0][1]){
        echo "<script>alert('Se ha encontrado el correo electronico')</script>";
        $_SESSION['email'] = $email;
        echo '<script>window.location = "question.php"; </script>';
    } else {
        echo "<script>alert('No se ha encontrado el correo electronico')</script>";
    }
                ...
                <div class="row " >
                    <div class="col-lg-7">    
                        <div class="register-form datos-cent">
                            <div class="row">
                            <form action="recover-password.php" id="frminsertar" name="frminsertar" method="POST" onsubmit="return validar()">
                                <div class="col-md-10">
                                    <label>¿Recuerdas tu correo?</label>
                                ...
                                <input type="submit" name="btniniciar" id="btniniciar" class="btn" value="Enviar" onclick="return validateEmail()">
