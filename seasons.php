...
?>
        ...
        function validar()
    {
        var tem = document.getElementById("txttemp").value;
...
function verificar_temporada(id)
	{
	  $.getJSON("Validaciones/verificar_temporada.php?p=" + id).done(function(datos)  
	    {
	      if (datos[0][0]>0) 
	      {
	        alert("Este periodo de temporada ya existente");
	        window.location="seasons.php";
	      }        
	    });  

        var texto = document.getElementById('txttemp').value;
    var regex = /^[0-9-]+$/;

    if (regex.test(texto)) {
        return true;
    } else {
        alert('El campo periodo debe de estar conformador por numeros (año que comenzo la temporada) guion (-) numeros ( año que termino la temporada)');
    ...
    if (regex.test(texto)) {
        ...
        alert('El texto debe contener solo números y guiones (-)');
...
function validarmodal()
    {
        var tem = document.getElementById("tempo").value;
        ...
        function eliminar(id){
         if (confirm("¿Estas seguro de eliminar el registro?")) {
            ...
            window.location = "seasons.php?id_eliminar=" + id;

         }
      }

      function modificar(id){
         window.location = "seasons.php?idmodificar=" + id;
      }
...
if (isset($_POST['btninsertar'])){
    $temporada = $_POST['txttemp'];
    $nombre = $_POST['txtnombre'];
    @$result = $obj->Ejecutar_Instruccion("INSERT INTO `temporadas`(`anos`, `nombre`) VALUES ('$temporada','$nombre')");
    echo '<script>window.location = "seasons.php"; </script>';
    }
    else if (isset($_GET['id_eliminar']))
        {
            $id = $_GET['id_eliminar'];
             $obj->Ejecutar_Instruccion("delete from temporadas where id_temporada = '$id'");
        }
        if (isset($_POST['btnbuscar'])){
@$buscar = $_POST['txtbuscar'];
$result = @$obj->Ejecutar_Instruccion("select * from temporadas WHERE anos LIKE '%$buscar%' or nombre LIKE '%$buscar%' ");
}
else{
$result = $obj->Ejecutar_Instruccion("select * from temporadas");
}
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                         ...
                         <a href="leagues.php" class="nav-item nav-link">Ligas</a>
                            ...
                            <a href="seasons.php" class="nav-item nav-link active">Temporadas</a>
                                <?php
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="section_tittle text-center">
                        <h1 class="text-uppercase">Temporadas</h1>
                    </div>
                </div>
            </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5">    
                        ...
                        <h3 class="mb-30">Formulario</h3>
                            <div class="row">
                            <form action="seasons.php" id="frminsertar" name="frminsertar" method="POST" autocomplete="off" onsubmit="return validar()">
                                <div class="col-md-10">
                                    <label>Periodo</label>
                                    <input class="form-control" type="text" name="txttemp" id="txttemp" placeholder="Periodo en que paso la temporada" pattern="[0-9-]+" onblur="javascript: verificar_temporada(this.value);" maxlength="9" minlength="9" style="width: 392px;">
                                </div>
                                <div class="col-md-10">
                                    <label>Nombre</label>
                                    <input class="form-control" type="text" name="txtnombre" id="txtnombre" placeholder="Nombre (Opcional)" style="width: 392px;">
                                </div>
        ...
        <!-- Modal Rechazar -->
		  <div class="modal fade" id="editar" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                     ...
                     <!--formulario-->
                     <form action="seasons-edit.php" method="POST" enctype="multipart/form-data" onsubmit="return validarmodal()">
                                     <div class="form-group">
                                <div class="col-md-10">
                                <input type="hidden" id="ide" name="txtid"  class="form-control" placeholder="ID">
                                    <label>Periodo</label>
                                    <input class="form-control" type="text" name="txttemp" id="tempo" placeholder="Periodo de la Temporada"  pattern="[0-9-]+" onblur="javascript: verificar_temporada(this.value);" maxlength="9" minlength="9"  style="width: 392px;">
                                </div>
                                <div class="col-md-10">
                                    <label>Nombre</label>
                                    <input class="form-control" type="text" name="txtnombre" id="nom" placeholder="Nombre (Opcional)" style="width: 392px;">
                                </div>
                                     </div>
