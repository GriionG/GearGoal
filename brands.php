...
?>
        ...
        function validar()
    {
        var nom = document.getElementById("txtmarca").value;

        if (nom.trim().length<1) 
        {
            alert("El campo nombre de marca esta vacio");
            return false;
        }
...
function eliminar(id){
         if (confirm("¿Estas seguro de eliminar el registro?")) {
            ...
            window.location = "brands.php?id_eliminar=" + id;

         }
      }

      function modificar(id){
         window.location = "brands.php?idmodificar=" + id;
      }
...
if (isset($_POST['btninsertar'])){
    ...
    @$result = $obj->Ejecutar_Instruccion("INSERT INTO `marca`( `nombre`) VALUES ('$marca')");
    echo '<script>window.location = "brands.php"; </script>';
    }
    else if (isset($_GET['id_eliminar']))
        {
            $id = $_GET['id_eliminar'];
             $obj->Ejecutar_Instruccion("delete from marca where id_marca = '$id'");
        }
        if (isset($_POST['btnbuscar'])){
@$buscar = $_POST['txtbuscar'];
$result = @$obj->Ejecutar_Instruccion("select * from marca WHERE nombre LIKE '%$buscar%'");
}
else{
$result = $obj->Ejecutar_Instruccion("SELECT * FROM marca");
}

$equipo = $obj->Ejecutar_Instruccion("SELECT * FROM marca");
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                         ...
                         <a href="leagues.php" class="nav-item nav-link">Ligas</a>
                            ...
                            <a href="brands.php" class="nav-item nav-link active">Marcas</a>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5">    
                        ...
                        <h3 class="mb-30">Formulario</h3>
                            <div class="row">
                            <form action="brands.php" id="frminsertar" name="frminsertar" method="POST" autocomplete="off" onsubmit="return validar()">
                                <div class="col-md-10">
                                    <label>Nombre</label>
                                    <input class="form-control" type="text" name="txtmarca" id="txtmarca" placeholder="Nombre" onblur="javascript: verificar_marca(this.value);" maxlength="30" minlength="1"  style="width: 392px;">
                                </div>
        ...
        <!-- Modal Rechazar -->
		  <div class="modal fade" id="editar" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                     ...
                     <!--formulario-->
                     <form action="brands-edit.php" method="POST" enctype="multipart/form-data" onsubmit="return validarmodal()">
                                     <div class="form-group">
                                <div class="col-md-10">
                                <input type="hidden" id="ide" name="txtid"  class="form-control" placeholder="ID">
                                <label>Nombre</label>
                                    <input class="form-control" type="text" name="txtmarca" id="marc" placeholder="Nombre" onblur="javascript: verificar_marca(this.value);" maxlength="30" minlength="1" style="width: 435px;">
                                </div>
                                     </div>
