...
?>
        ...
        function eliminar(id){
         if (confirm("¿Estas seguro de eliminar el registro?")) {
            ...
            window.location = "users.php?id_eliminar=" + id;

         }
      }

      function modificar(id){
         window.location = "users.php?idmodificar=" + id;
      }
...
if (isset($_POST['btninsertar'])){
    @$result = $obj->Ejecutar_Instruccion("");
...
$result = @$obj->Ejecutar_Instruccion("select * from usuarios WHERE nombre LIKE '%$buscar%' or email LIKE '%$buscar%' ");
}
else{
                         ...
                         <a href="leagues.php" class="nav-item nav-link">Ligas</a>
                            ...
                            <a href="seasons.php" class="nav-item nav-link">Temporadas</a>
                                <?php
                                 ...
                                 ?>
                               <a href="users.php" class="nav-item nav-link active">Usuarios</a>
                                <?php } 
                                else 	{
                                ?>
		  ...
		  <div class="modal fade" id="editar" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                     ...
                     <form action="users-edit.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
                                <input type="hidden" id="ide" name="txtid" readonly  class="form-control" placeholder="ID">
                                    <label>Nombre (s)</label>
                                    <input class="form-control" type="text" readonly placeholder="Nombre (s)" name="txtnombre" id="nom" maxlength="50" minlength="2" style="width: 435px;">
                                </div>
                                <div class="col-md-10">
                                    <label>Apellido (s)"</label>
                                    <input class="form-control" type="text" readonly placeholder="Apellido (s)" name="txtapellido" id="ape" maxlength="60" minlength="3" style="width: 435px;">
                                </div>
                                <div class="col-md-10">
                                    <label>Correo</label>
                                    <input class="form-control" type="text" readonly placeholder="Correo" name="txtcorreo" id="corr" maxlength="100" minlength="8" data-validation-required-message="Por favor ingresa tu usuario." 
                                     onblur="javascript: buscar_usuario(this.value);" style="width: 435px;">
                                </div>
                                <div class="col-md-10">
                                    <label>Num. Celular</label>
                                    <input class="form-control" type="text" readonly placeholder="Numero Celular" name="txtNumcel" id="num" pattern="[0-9]+" maxlength="10" minlength="10" onkeypress="return check(event)" style="width: 435px;">
                                </div>
                                <div class="col-md-10">
                                    <label>Direccion</label>
                                    <input class="form-control" type="text"  readonly placeholder="Direccion" name="txtdireccion" id="dire"  minlength="20" style="width: 435px;">
                                </div>
                                <div class="col-md-10">
                                    <label>Descripcion</label>
                                    <input class="form-control" type="text" readonly placeholder="Descripcion" name="txtdescripcion" id="discre" minlength="20" style="width: 435px;">
                                </div>
                                <div class="col-md-10">
                                    <label>Privilegio</label>
                                    <select  name="frmprivilegio" id="pri" class="form-control" style="width: 435px;">
