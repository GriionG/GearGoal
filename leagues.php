...
?>
        ...
        function validar()
    {
        var nom = document.getElementById("txtliga").value;
        var pais = document.getElementById("txtpais").value;

        if (nom.trim().length<1) 
        {
            alert("El campo nombre de liga esta vacio");
            return false;
        }
...
function verificar_liga(id)
	{
	  $.getJSON("Validaciones/verificar_liga.php?p=" + id).done(function(datos)  
	    {
	      if (datos[0][0]>0) 
	      {
	        alert("Esta Liga ya existente");
	        window.location="leagues.php";
	      }        
	    });  
    ...
    {
        var nom = document.getElementById("lig").value;
        var pais = document.getElementById("pai").value;
        ...
        function eliminar(id){
         if (confirm("¿Estas seguro de eliminar el registro?")) {
            ...
            window.location = "leagues.php?id_eliminar=" + id;

         }
      }

      function modificar(id){
         window.location = "leagues.php?idmodificar=" + id;
      }
...
if (isset($_POST['btninsertar'])){
    $liga = $_POST['txtliga'];
    $pais = $_POST['txtpais'];
    @$result = $obj->Ejecutar_Instruccion("INSERT INTO `liga`(`nombre`, `pais`) VALUES ('$liga','$pais')");
    echo '<script>window.location = "leagues.php"; </script>';
    }
    else if (isset($_GET['id_eliminar']))
        {
            $id = $_GET['id_eliminar'];
             $obj->Ejecutar_Instruccion("delete from liga where id_liga = '$id'");
        }
        if (isset($_POST['btnbuscar'])){
@$buscar = $_POST['txtbuscar'];
$result = @$obj->Ejecutar_Instruccion("select * from liga WHERE nombre LIKE '%$buscar%' or pais LIKE '%$buscar%' ");
}
else{
$result = $obj->Ejecutar_Instruccion("select * from liga");
}
            ...
            <div class="container-fluid">
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                         ...
                         <a href="leagues.php" class="nav-item nav-link active">Ligas</a>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="section_tittle text-center">
                        <h1 class="text-uppercase">Ligas</h1>
                    </div>
                </div>
            </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5">    
                        ...
                        <h3 class="mb-30">Formulario</h3>
                            <div class="row">
                            <form action="leagues.php" id="frminsertar" name="frminsertar" method="POST" autocomplete="off" onsubmit="return validar()">
                                <div class="col-md-10">
                                    <label>Nombre</label>
                                    <input class="form-control" type="text" name="txtliga" id="txtliga" placeholder="Nombre de Liga" onblur="javascript: verificar_liga(this.value);" maxlength="30" minlength="1" style="width: 392px;">
                                </div>
                                <div class="col-md-10">
                                    <label>Pais</label>
                                    <input class="form-control" type="text" name="txtpais" id="txtpais" placeholder="Pais" maxlength="30" minlength="1" style="width: 392px;">
                                </div>
        ...
        <!-- Modal Rechazar -->
		  <div class="modal fade" id="editar" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                     ...
                     <!--formulario-->
                     <form action="leagues-edit.php" method="POST" enctype="multipart/form-data" onsubmit="return validarmodal()">
                                     <div class="form-group">
                                <div class="col-md-10">
                                <input type="hidden" id="ide" name="txtid"  class="form-control" placeholder="ID">
                                    <label>Nombre</label>
                                    <input class="form-control" type="text" name="txtliga" id="lig" placeholder="Nombre de Liga" onblur="javascript: verificar_liga(this.value);" maxlength="30" minlength="1" style="width: 435px;">
                                </div>
                                <div class="col-md-10">
                                    <label>Pais</label>
                                    <input class="form-control" type="text" name="txtpais" id="pai" placeholder="Pais" maxlength="30" minlength="1" style="width: 435px;">
                                </div>
                                     </div>
