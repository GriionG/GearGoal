                ...
                <div class="row " >
                    <div class="col-lg-7">    
                        <div class="register-form datos-cent">
                            ...
                            <div class="col-md-10">
                            <label>Tu contraseña es esta</label>
                            <input class="form-control" type="text" placeholder="Contraseña" name="txtpassword" id="txtpassword" value="<?php echo @$datos[0][2] ?>" minlength="1"  style="width: 425px;">
                                </div>
                                <br>
                                <div class="col-md-12" style="padding-left:30%;">
                                <a href="login.php" style="padding-left: 0px;">Volver a Inicio de sesion</a>
