...
if (isset($_POST['btniniciar'])) {
    ...
    // Realizar la consulta utilizando el correo electrónico y la pregunta de recuperación
    $datos = $obj->Ejecutar_Instruccion("SELECT * FROM usuarios WHERE email='$email' AND pregunta='$pregunta'");
    ...
    if(!empty($datos)) {
        ...
        echo "<script>alert('Correcto, esta pregunta de recuperación válida')</script>";
        echo '<script>window.location = "response.php"; </script>';
    } else {
        echo "<script>alert('Incorrecto, esta no es tu pregunta de recuperación')</script>";
    }
                ...
                <div class="row " >
                    <div class="col-lg-7">    
                        <div class="register-form datos-cent">
                            <div class="row">
                            <form action="question.php" id="frminsertar" name="frminsertar" method="POST" onsubmit="return validar()">
                            <div class="col-md-10">
                                    <label>¿Recuerdas tu pregunta de recuperacion?</label>
                                    <select name="frmpregunta" id="frmpregunta" class="form-control" style="width: 425px;">
